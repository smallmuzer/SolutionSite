                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative z-10 p-4 h-full flex flex-col justify-end">
                        ...
                        <p className={`text-[0.8125rem] font-semibold leading-relaxed line-clamp-2 drop-shadow ${useImg ? "text-white/80" : "text-muted-foreground"}`}>
                          {content[card.key] || ""}
                        </p>
                      </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 relative z-10">
                        ...
                        <p className="text-muted-foreground text-[0.8125rem] font-semibold mt-0.5 line-clamp-1">{content[card.key] || ""}</p>
                      </div>
