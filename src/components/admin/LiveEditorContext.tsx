...
export const EditorToolbar: React.FC<{
  ...
  return (
    <div className={`absolute z-[100] flex items-center gap-3 ${group ? "opacity-0" : "opacity-100"} ${hoverClasses} transition-all duration-300 bg-card/95 backdrop-blur-md border border-border/50 ${isSmall ? "p-1 rounded-lg" : "p-1.5 rounded-xl"} shadow-2xl scale-90 origin-top-right ${className || "top-2 right-2"}`}>
      {imageField && (
