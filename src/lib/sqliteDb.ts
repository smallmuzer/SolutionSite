...
const SEED: Partial<TableStore> = {
  ...
  testimonials: [
    { id: "tst-1", name: "Ahmed Rasheed", company: "Villa Group", message: "Systems Solutions transformed our operations with their ERP system. The team was professional, responsive, and delivered exactly what we needed.", avatar_url: "/assets/uploads/Two_business_profess_1775325092342.png", rating: 5, is_visible: true, created_at: t0, updated_at: t0 },
    { id: "tst-2", name: "Fatima Zahir", company: "OBLU Resorts", message: "Their web development team built us a stunning booking platform. Traffic and conversions have increased significantly since launch.", avatar_url: "/assets/uploads/white_designer_1775410426535.png", rating: 5, is_visible: true, created_at: t0, updated_at: t0 },
    { id: "tst-3", name: "Dorji Wangchuk", company: "RCSC Bhutan", message: "Excellent consulting services. They understood our requirements perfectly and delivered a robust HR system on time and within budget.", avatar_url: "/assets/uploads/white_dev_1775409804566.png", rating: 5, is_visible: true, created_at: t0, updated_at: t0 },
  ],
  career_jobs: [
